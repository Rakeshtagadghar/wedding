            ...
            <div className="col col-xs-12">
              <div className="couple-area clearfix">
                <div className="text-grid bride">
                  <h3>Amulya Gongle</h3>
                  <p>
                    A bubbly natured girl, who is a perfect blend of independent
                    and emotional.
                  </p>
                  <div className="social">
                    <ul>
                      ...
                      <li>
                        <a
                          href="https://www.instagram.com/amulya_gongle/"
                          target="_blank"
                ...
                <div className="text-grid groom">
                  ...
                  <p>
                    A shy gaming freak, who is a mixture of maturity and a
                    little playfulness all set to claim her heart once and for
                    all.
                  </p>
                  <div className="social">
                    <ul>
                      <li>
                        <a
                          href="https://www.facebook.com/Rakeshdrocka"
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                      ...
                      <li>
                        <a
                          href="https://www.instagram.com/rtagadghar/"
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                          <i className="ti-instagram"></i>
